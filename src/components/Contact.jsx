  ...
  return (
    <section className="relative py-16 px-4 bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <div className="flex items-center gap-6 pt-4">
            ...
            <span
              className="text-green-600 text-2xl cursor-not-allowed hover:scale-110 transition"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-green-600 text-white p-4 rounded-full shadow-lg hover:bg-green-700 hover:scale-110 transition"
      >
